...
# 🤝 Group Rules & Community Cultue

To keep this space safe, supportive, and productive for everyone, please follow these simple group rules. Our goal is to create an environment where we can grow, learn, and challenge ourselves — together.

### **1. Be Kind and Courteous**
We’re all here to learn. Treat everyone with respect. Healthy discussion is encouraged, and kindness is required — especially when we’re pushing each other to improve.

### **2. Respect Everyone’s Privacy**
This group relies on trust. What’s shared here — including personal experiences, struggles, wins, and questions — must stay in the group.

### **3. No External Sharing of Group Content**
Everything shared in this group —
All posts, discussions, files, screenshots, and resources shared in this group must remain inside the group. Do not copy, forward, or distribute any group material externally to any platforms, individuals, public pages, or other private chats without explicit permission from the admins and the original content creator. Let's maintain a safe space for open collaboration.
