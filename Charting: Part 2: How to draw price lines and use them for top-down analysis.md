...
- Note the **overall trend direction** (bullish, bearish, or ranging)

---

## 2️⃣ 4‑Hour Chart (4H) — Medium Structure
- Refine the 1D levels (do NOT duplicate them)
- Mark **intermediate swing highs/lows**
...
- Check for a **volume spike** at the entry point
- Enter only when the **confirmation candle** forms
